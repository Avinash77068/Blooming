...
// import { TeacherImages } from "../../Array/AllArray";
    ...
    <div className={`${isOpen ? bgBlack : bgWhite}`}>
      ...
      <div className="max-w-full mx-auto px-4 sm:px-6 lg:px-8 pt-[70px] pb-12">
        <div className="text-center max-w-2xl mx-auto mb-6">
          ...
          >
            The School Teacher Gallery showcases memorable images of our
            teachers, highlighting their hard work and contributions to
            ...
            >
              <div>
                ...
                <div className="absolute bottom-0 left-0 right-0 text-black bg-white/40 bg-opacity-60 font-bold text-xs sm:text-sm p-2">
                  <p className="font-bold">{teacher[index]?.name}</p>
                  <p>{teacher[index]?.course}</p>
                </div>
              </div>
            </div>
          ))}
